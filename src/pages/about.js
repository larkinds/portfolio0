  ...
  return (
    <Layout>
      <div className="about">
        ...
        <br></br>
        <br></br>
        After a brief stint of eating haggis and (successfully) willing herself to like whisky at the University of St. Andrews, Larkin transfered to Sarah Lawrence where she got the most liberal arts-y of educations. She then spent a few years bouncing around the film industry and feeling unfulfilled before finding out that solving puzzles with code brings her great satisfaction. That being said, Larkin believes that <a className="about-link" href="https://workwontloveyouback.org/" target="_blank" rel="noreferrer">work won’t love you back</a> and the fact that she likes what she does is just a lucky coincidence and a solid example of a dialectic.
        </p>
